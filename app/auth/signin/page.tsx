        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl text-[#3C4858]">
              ...
              {step === "sign-up-options" && "Create Your Account"}
              {step === "email-signup" && "Sign Up with Email"}
              {step === "phone-signup" && "Complete Your Profile"}
            </CardTitle>
            <CardDescription className="text-[#3C4858]/70">
              {step === "phone-check" && "Enter your phone number to get started"}
          ...
          <CardContent className="space-y-6">
            ...
            {step === "sign-up-options" && (
              <div className="space-y-4">
                <div className="text-center text-sm text-[#3C4858]/70 mb-4">
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full border-[#3C4858]/20 hover:bg-[#7BAFB0]/10"
                >
                ...
                <Button
                  ...
                  className="w-full bg-[#7BAFB0] hover:bg-[#6D9E9F] text-white"
                >
                ...
                <Button
                  ...
                  variant="ghost"
                  className="w-full text-[#3C4858]/70 hover:text-[#3C4858]"
                >
